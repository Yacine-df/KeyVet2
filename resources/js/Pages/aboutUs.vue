            ...
            <div class="container mx-auto w-full h-full">
                ...
                <section class=" relative overflow-hidden h-full">
                    ...
                    <div class="px-4 flex flex-col">
                        ...
                        <CardHistory class="justify-start">
                            <template #number>1</template>
                            <template #date>25-10-2023</template>
                            <template #event>
                                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Veritatis earum minus cum.
                                Impedit itaque voluptates repudia
                                ndae harum dicta possimus non nostrum provident? Magni voluptatem neque quasi harum
                                praesentium corporis repellendus!
                            </template>
                        </CardHistory>

                        <CardHistory class="justify-center">
                                    ...
                                    <li class="my-4 shadow-lg rounded-lg text-black">
                                        <div class="md:flex gap-x-6 py-2 px-4 md:py-0 md:px-0">
                                            <img class="w-32 h-32 md:w-48 md:h-auto rounded-full md:rounded-sm mx-auto"
                                                ...
                                                alt="" />
                                            <div class="py-4">
                                                <h3 class="text-base font-medium leading-7 tracking-tight">
                                                    Dr Messaoudene Abdelhakim
                                                </h3>
                                                <span
                                                    class="text-sm  font-bases ring-blue-500 text-blue-600 px-2 py-1 rounded-full">
                                                    Veterinarian doctor
                                                </span>
                                                <p class="text-sm font-normal py-2">
                                                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Culpa
                                                    perspiciatis
                                                    ea cupiditate excepturi in reiciendis, commodi debitis vel,
                                                    voluptates voluptas vitae, dolor accusamus pariatur minus deleniti
                                    ...
                                    <li class="my-4 shadow-lg  rounded-lg text-black">
                                        <div class="md:flex gap-x-6 py-2 px-4 md:py-0 md:px-0">
                                            ...
                                            <div class="py-4">
                                                ...
                                                <span class="text-sm font-bases text-blue-600 px-2 py-1 rounded-full">
                                                    Veterinarian doctor
                                                </span>
                ...
                <!-- end Keyvet team section -->
                <!-- start contact us section -->
                <section class="relative bg-white mt-48 rounded-3xl shadow-2xl">
                    <div
                        class="absolute -z-10 top-0 left-0 h-full w-full -ml-full rounded-3xl transform shadow-2xl bg-gradient-to-br from-blue-950 to-blue-500 -rotate-2 sm:-rotate-2">
                    </div>
                                ...
                                <div class="mt-6 space-y-8 md:mt-8">
                                    <p class="flex items-start -mx-2">
                                        ...
                                        <span class="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">
                                            Algeria, Bordj Bou Arreridj, Cmn El Achir.
                                        </span>
                                    </p>
                                    ...
                                    <p class="flex items-start -mx-2">
                                        ...
                                        <span class="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">(213)
                                            563-7401</span>
                                    </p>
                                    ...
                                    <p class="flex items-start -mx-2">
                                        ...
                                        <span
                                            class="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">abdelhadi.messaoudene@yahoo.com</span>
                                    </p>
                                </div>
                ...
                <!-- start map section -->
                <section class="container mt-10 px-6 p-12 mx-auto">
                    <h1 class="text-5xl text-center py-4 my-4">You Can Find Us here 🌍</h1>
                    <div class="w-full">
                        <iframe class="w-full rounded-lg" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3225.165346688642!2d4.6370558747517965!3d36.06507090879512!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x128c918223eae623%3A0x6cc865c719fa565!2z2LnZitin2K_YqSDYqNmK2LfYsdmK2Kkga2V5dmV0!5e0!3m2!1sfr!2sdz!4v1696763588512!5m2!1sfr!2sdz"
                        height="600" style="border:0;" allowfullscreen="true" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </section>
                <!-- end map section -->
            </div>
